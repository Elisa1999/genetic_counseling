...
We were also curious about the ECOG which measured well-being. As a result, we use the same method as the previous analysis.The stacked bar plot presents the proportions of individuals who ordered testing based on the patient’s level of functioning in terms of their ability to care for themselves (ECOG Status).
