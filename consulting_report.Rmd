...
webshot("sankey_plot.html" , "output.pdf", delay = 0.2)
```
...
=======
```{r echo=FALSE, message=FALSE, fig.cap= 'Propotion of patients who order tests in each ECOG level'}
ggplot(df6, aes(x = `ECOG at Initial (#0-4)`, y = n, fill = `Testing Ordered`)) +
>>>>>>> 433cd3f52577169ed4b24ddad2c21074c041c3ef
   geom_bar(position = position_stack(), stat = "identity") +
   geom_text(aes(label = label), position = position_stack(vjust = 0.5), size = 3, color="white")+
