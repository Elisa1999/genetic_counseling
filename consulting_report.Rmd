...
The bar plots below contains both of acceptance and rejection groups of patients who ordered testing diagnosed with different stages of cancer. The numbers and percentages on bars are same with the previous corresponded bar plots. And the bar plots below presents the relationship among patients in diversity of ECOG status and the referral rates in acceptance and rejection groups.
